...
function App() {
  return (
    <>
      ...
      <div className="bg-[#ff5733] h-41.25 w-75 border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
        Custom Width, Height and Color
      </div>
      <div className="bg-dilip-500 h-41.25 w-75 border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
        Theme variables
      </div>
      <div className="bg-primary font-display h-41.25 w-75 border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
